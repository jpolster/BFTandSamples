...
#define g_szPipeName L"\\\\.\\Pipe\\MyNamedPipe"
...
void TrackFacesInWebcam::sendNumber(int n) {
	using namespace std;
	...
	/*C:\Users\Username\AppData\Local\Packages\Microsoft.SDKSamples.FaceTracking.CPP_8wekyb3d8bbwe\LocalState*/
	...
	char fileName[512];
	sprintf_s(fileName, "%s\\faces.txt", charStr);
...
Platform::String ^ TrackFacesInWebcam::convertFromString(const std::string & input)
{
